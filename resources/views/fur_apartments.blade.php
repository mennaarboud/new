...
<body style="background-color:#f6f6f6;">
  ...
  <i><ul vocab="https://schema.org/" typeof="BreadcrumbList" class="breadcrumb" style="background-color: rgba(212,212,206,.5);color:#023246;">
    ...
    <li class="active last"><span style="-webkit-text-stroke: .2px gold"> Furnished Apartments</span></li></ul></i>
  </div>
<!-- ///////////////////end of breadcrumb//////////////////// -->
...
<div class="container" style="margin-bottom:75px;">
        <!-- Featured Properties -->
          <div class="main-title">
              <h1><b>Furnished Apartments</b> <small>for sale or rent</small></h1>
  ...
  <div class="row no-gutters">
        ...
        <div class="col-lg-3 col-sm-6"><div class="col-lg-12">
          <div class=" card wow fadeInLeft delay-04s property-box-2" style="background-color:#D4D4CE; ">
            <div class="card-img-body">
              <img src="images/property-2.jpg" alt="property-2" class="img-fluid">
            </div>
            <div class="card-body">
              <h6 class="card-title"> <small><i class="fa fa-map-marker-alt"></i></small> <b>Nile Dolphin Residence and Hotel Apartments</b></h6>
              <h6 class="price"><i class="fas fa-dollar-sign"></i>&nbsp; 1,950,000 EGP</h6><hr>
        ...
        <div class="col-lg-3 col-sm-6"><div class="col-lg-12">
          <div class=" card wow fadeInLeft delay-04s property-box-2" style="background-color:#D4D4CE;">
            <div class="card-img-body">
              <img src="images/property-4.jpg" alt="property-4" class="img-fluid">
            </div>
            <div class="card-body">
        ...
        <div class="col-lg-3 col-sm-6"><div class="col-lg-12">
          <div class=" card wow fadeInLeft delay-04s property-box-2" style="background-color:#D4D4CE; ">
            <div class="card-img-body">
              <img src="images/property-5.jpg" alt="property-5" class="img-fluid">
            </div>
            <div class="card-body">
        ...
        <div class="col-lg-3 col-sm-6"><div class="col-lg-12">
          <div class=" card wow fadeInLeft delay-04s property-box-2" style="background-color:#D4D4CE; ">
            <div class="card-img-body">
              <img src="images/property-11.jpg" alt="property-11" class="img-fluid">
            </div>
            <div class="card-body">
              <h6 class="card-title"> <small><i class="fa fa-map-marker-alt"></i></small> <b>Madinaty Apartment,cairo</b></h6>
